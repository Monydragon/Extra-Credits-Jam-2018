...
public class TileMovement
{
    ...
    public GameObject InteractedGameObject()
    {
        ...
        {
            case MoveDirection.UP: go = Up != null ? Up.gameObject : null; break;
            case MoveDirection.RIGHT: go = Right != null ? Right.gameObject : null; break;
            case MoveDirection.LEFT: go = Left != null ? Left.gameObject : null; break;
            case MoveDirection.DOWN: go = Down != null ? Down.gameObject : null; break;
            case MoveDirection.UP_LEFT: go = UpLeft != null ? UpLeft.gameObject : null; break;
            case MoveDirection.UP_RIGHT: go = UpRight != null ? UpRight.gameObject : null; break;
            case MoveDirection.DOWN_RIGHT: go = DownRight != null ? DownRight.gameObject : null; break;
            case MoveDirection.DOWN_LEFT: go = DownLeft != null ? DownLeft.gameObject : null; break;
        }
