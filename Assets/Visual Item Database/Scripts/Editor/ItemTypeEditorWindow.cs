...
public class ItemTypeEditorWindow : EditorWindow
{
    ...
    string editorWindowFile = @"/ItemDatabaseEditorWindow.cs", itemBaseFile = @"/ItemBase.cs", itemDatabaseFile = @"/" + ItemDatabaseV32.dbName + ".cs",
        itemUtilityFile = @"/ItemSystemUtility.cs", vidListsFile = @"/" + VIDItemListsV32.itemListsName + ".cs";
