...
public class MultiTags : MonoBehaviour {
	...
	public void Awake()
	{
		...
		public static GameObject FindGameObjectWithMultiTag(string tag)
		{
...
{
    public static IEnumerable<string> MultiTags(this GameObject go)
    {
        MultiTags tagComp = go.GetComponent<MultiTags>();
        return tagComp.localTagList.Select(x => x.Name).ToArray();
    }
