...
public class ObjectBuilderEditor : Editor
{
		...
		if (GUILayout.Button ("New Tag(Global/Local)", GUILayout.Width (150))) 
		{
		...
		if (GUILayout.Button ("New Tag(Local)", GUILayout.Width (125))) 
		{
		...
		if (GUILayout.Button ("New Tag(Global)", GUILayout.Width (125))) 
		{
			tagDescription = tagDescription.Trim();
			...
			MT itemGlobal = new MT ();
			itemGlobal.Name = tagDescription;
